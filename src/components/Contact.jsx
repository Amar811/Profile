  ...
  return (
    ...
    >
        ...
        lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href,icon,alt},key)=>(
                       ...
                       alt={alt}
                        target='_blank'
                       className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-
                       [background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zin-50/80 reveal-up'
            ...
            <form 
            action="https://getform.io/f/amdmeddb"
            method="POST"
                    ...
                    <div className="mb-4">
                      ...
                      <div className="mb-4">
                        ...
                        type="text"
                         ...
                         autoComplete='email'
                         required
                         placeholder='ramamar151@gmail.com'
                         className="text-field reveal-up" 
                         />
                    </div>
                </div>
